...
public class MonsterSprite extends Sprite
{
	...
	public void update()
	{
		...
		{
			if(this.nextScriptInt(GameConsts.MONSTER_HURT_SCRIPT.length))
			{
	...
	public void drawView(Canvas canvas)
	{
		...
		else if(state == HURT_STONE)
		{
			this.drawImage(canvas, 
					GameConsts.MONSTER_HURT_SCRIPT[scriptInt],
	...
	public void drawMonster(Canvas canvas)
	{
		if(isHurt||state == DEAD)
		{
			this.drawRect(canvas, x + GameConsts.MONSTER_HP_POSITION[0], y
					+ GameConsts.MONSTER_HP_POSITION[1], GameConsts.MONSTER_HP_POSITION[2]*hp/maxHp, 
					GameConsts.MONSTER_HP_POSITION[3], alpha, 255, 0, 0);
			this.drawStrokeRect(canvas, x + GameConsts.MONSTER_HP_POSITION[0], y
					+ GameConsts.MONSTER_HP_POSITION[1], GameConsts.MONSTER_HP_POSITION[2], 
					GameConsts.MONSTER_HP_POSITION[3], alpha, 0, 0, 0,GameConsts.MONSTER_HP_POSITION[4]);
		}
	}
	public int getSpeed()
	{
	...
	{
		if(state!=MonsterSprite.DEAD&&
		   state!=MonsterSprite.DEAD_END)
		{
			return true;
		}
		return false;
